...
template <typename T>
inline particle::EnumFlags<T>& particle::EnumFlags<T, typename std::enable_if_t<std::is_enum<T>::value>>::set(
    const EnumFlags<T>& flags)
{
    value_ |= flags.value_;
    return *this;
}
...
template <typename T>
inline particle::EnumFlags<T>& particle::EnumFlags<T, typename std::enable_if_t<std::is_enum<T>::value>>::clear(
    const EnumFlags<T>& flags)
{
    value_ &= (~flags.value_);
    return *this;
...
particle::EnumFlags<T, typename std::enable_if_t<std::is_enum<T>::value>>::value() const
{
    return value_;
}
...
template <typename T>
inline bool particle::EnumFlags<T, typename std::enable_if_t<std::is_enum<T>::value>>::isSet(
    const EnumFlags<T>& flags) const
{
    return ((value_ & flags.value_) == flags.value_);
}

template <typename T>
inline particle::EnumFlags<T> particle::EnumFlags<T, typename std::enable_if_t<std::is_enum<T>::value>>::operator&(
    const EnumFlags<T>& flags) const
{
...
template <typename T>
inline bool particle::EnumFlags<T, typename std::enable_if_t<std::is_enum<T>::value>>::operator==(
    const EnumFlags<T>& flags) const
{
...
template <typename T>
inline particle::EnumFlags<T> particle::EnumFlags<T, typename std::enable_if_t<std::is_enum<T>::value>>::fromUnderlying(
    ValueType value)
{
